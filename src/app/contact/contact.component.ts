...
export class ContactComponent {
  ...
  let count:any=localStorage.getItem('Id');
    if(count==null||count==0)
    {
          ...
          let url:String="https://retoolapi.dev/jYvBdj/Contact";
        this.http.put("https://retoolapi.dev/jYvBdj/Contact/"+count,list).subscribe(
        ()=>{
    ...
    else
    {
        ...
        this.http.put("https://retoolapi.dev/jYvBdj/Contact/"+a,list).subscribe(
        ()=>{
        alert("Message sent successfully... we will get to you soon.. ");
      },
      err=>{
